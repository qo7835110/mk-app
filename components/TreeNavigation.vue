<template>
    <div class="w-[400px] flex flex-col items-center mt-[38px]">
        <!-- Logo -->
        <div class="w-[162px]">
        ...
        <!-- 樹狀導航 -->
        <div class="w-full max-w-[300px] mt-[48px] space-y-2">
            <!-- 主界面 -->
            <div class="rounded-xl bg-[#ebe2dc] overflow-hidden">
                <div 
                    class="flex items-center justify-between h-[48px] px-[20px] py-[16px] cursor-pointer hover:bg-[#ddd4cc] transition-colors"
                ...
                >
                    ...
                    <div class="transition-transform duration-200" :class="{ 'rotate-180': expandedSections.main }">
                ...
                <!-- 主界面子項目 -->
                <div v-show="expandedSections.main" class="pb-2 bg-[#f5efea]">
                    <div class="px-6 py-2 text-sm text-gray-700 hover:bg-[#ebe2dc] cursor-pointer flex items-center">
            ...
            <div class="rounded-xl bg-[#ebe2dc] overflow-hidden">
                ...
                >
                    <div class="flex items-center">
                        <div>
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12 6.75V17.25M8.25 12H15.75" stroke="#242220" stroke-width="1.5" stroke-linecap="round"/>
                                <path d="M3 12C3 16.9706 7.02944 21 12 21C16.9706 21 21 16.9706 21 12C21 7.02944 16.9706 3 12 3C7.02944 3 3 7.02944 3 12Z" stroke="#242220" stroke-width="1.5"/>
                            </svg>
                        </div>
                        <div class="font-black text-xl ml-3">教案版</div>
                    </div>
                    <div class="transition-transform duration-200" :class="{ 'rotate-180': expandedSections.lessons }">
                        <svg width="12" height="7" viewBox="0 0 12 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                fill-rule="evenodd"
                                clip-rule="evenodd"
                ...
                <!-- 教案版子項目 -->
                <div v-show="expandedSections.lessons" class="pb-2 bg-[#f5efea]">
                    <div class="px-6 py-2 text-sm text-gray-700 hover:bg-[#ebe2dc] cursor-pointer flex items-center">
                        <div class="w-4 h-4 mr-3">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="8" cy="8" r="2" fill="#666"/>
            ...
            <div class="rounded-xl bg-[#ebe2dc] overflow-hidden">
                <div 
                    class="flex items-center justify-between h-[48px] px-[20px] py-[16px] cursor-pointer hover:bg-[#ddd4cc] transition-colors"
                    @click="toggleSection('flipped')"
                >
                    <div class="flex items-center">
                        <div>
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8 7V17L16 12L8 7Z" stroke="#242220" stroke-width="1.5" stroke-linejoin="round"/>
                                <circle cx="12" cy="12" r="9" stroke="#242220" stroke-width="1.5"/>
                            </svg>
                        </div>
                        <div class="font-black text-xl ml-3">反轉學習</div>
                    </div>
                    <div class="transition-transform duration-200" :class="{ 'rotate-180': expandedSections.flipped }">
                        <svg width="12" height="7" viewBox="0 0 12 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                fill-rule="evenodd"
                                clip-rule="evenodd"
                ...
                <!-- 反轉學習子項目 -->
                <div v-show="expandedSections.flipped" class="pb-2 bg-[#f5efea]">
                    <div class="px-6 py-2 text-sm text-gray-700 hover:bg-[#ebe2dc] cursor-pointer flex items-center">
                        <div class="w-4 h-4 mr-3">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="8" cy="8" r="2" fill="#666"/>
            ...
            <div class="rounded-xl bg-[#ebe2dc] overflow-hidden">
                ...
                >
                    <div class="flex items-center">
                        <div>
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M3 21H21M3 7L12 3L21 7V21H3V7Z" stroke="#242220" stroke-width="1.5" stroke-linejoin="round"/>
                                <path d="M9 21V12H15V21" stroke="#242220" stroke-width="1.5" stroke-linejoin="round"/>
                            </svg>
                        </div>
                        <div class="font-black text-xl ml-3">MK大廈</div>
                    </div>
                    <div class="transition-transform duration-200" :class="{ 'rotate-180': expandedSections.building }">
                        <svg width="12" height="7" viewBox="0 0 12 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                fill-rule="evenodd"
                                clip-rule="evenodd"
                ...
                <!-- MK大廈子項目 -->
                <div v-show="expandedSections.building" class="pb-2 bg-[#f5efea]">
                    <div class="px-6 py-2 text-sm text-gray-700 hover:bg-[#ebe2dc] cursor-pointer flex items-center">
                        <div class="w-4 h-4 mr-3">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="8" cy="8" r="2" fill="#666"/>
