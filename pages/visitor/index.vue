<template>
    <div class="rounded-2xl h-full flex py-[38px]">
        <div class="w-[400px] flex flex-col items-center">
            ...
            <div
                class="flex items-center justify-between h-[48px] w-[196px] mt-[48px] rounded-xl bg-[#ebe2dc] px-[20px] py-[16px]">
            ...
            <div
                class="flex items-center justify-between h-[48px] w-[196px] mt-[12px] rounded-xl px-[20px] py-[16px] text-[#adaca7]">
                <div class="flex items-center">
                    <div>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div
                class="flex items-center justify-between h-[48px] w-[196px] mt-[12px] rounded-xl px-[20px] py-[16px] text-[#adaca7] text-[11px]">
                與專屬 CAT 聯繫
                <svg width="13" height="16" viewBox="0 0 13 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                        d="M8.61547 15H4.38547C2.48448 14.9677 0.969283 13.401 1.00047 11.5V8C0.983141 6.42628 2.02358 5.03658 3.53847 4.61V4.15C3.48798 2.46276 4.81332 1.0533 6.50047 1C8.18763 1.0533 9.51296 2.46276 9.46247 4.15V4.61C10.9774 5.03658 12.0178 6.42628 12.0005 8V11.5C12.0317 13.401 10.5165 14.9677 8.61547 15Z"
        ...
        <div class="flex-1 flex-col items-center justify-center px-[36px]">
            <div class="flex items-center justify-between w-full">
                <div class="h-[50px] w-[440px] bg-white rounded-full flex items-center px-10 text-[#8A8A8A]">
                    <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            d="M11.7558 0C18.1447 0 23.3414 5.17315 23.3414 11.533C23.3414 14.5335 22.1847 17.2702 20.2917 19.3241L24.0165 23.0242C24.3651 23.3712 24.3663 23.9326 24.0177 24.2796C23.844 24.4548 23.6144 24.5413 23.3859 24.5413C23.1587 24.5413 22.9303 24.4548 22.7554 24.2819L18.9856 20.5398C17.0026 22.1207 14.4882 23.0672 11.7558 23.0672C5.3669 23.0672 0.168945 17.8928 0.168945 11.533C0.168945 5.17315 5.3669 0 11.7558 0ZM11.7558 1.77649C6.35081 1.77649 1.95355 6.15259 1.95355 11.533C1.95355 16.9134 6.35081 21.2907 11.7558 21.2907C17.1596 21.2907 21.5568 16.9134 21.5568 11.533C21.5568 6.15259 17.1596 1.77649 11.7558 1.77649Z"
                            fill="#242220" fill-opacity="0.56" />
                    </svg>
                    <div class="ml-2">
                        搜尋課程、話題、教材、學習方法教學等等
            ...
            <div class="flex justify-between">
                <div class="w-[716px]">
                    <div class="font-black text-[32px] mt-10 mb-2 text-brown">
                        最新公告
                    </div>
                    <small class="text-[#8A8A8A]">
                        最新的課程通知、講座活動、遊學團都在這裡！
                    </small>
                    <div class="">
                        <img src="~/assets/images/ad1.png" alt="" srcset="">
                    </div>
                </div>
                <div class="">
                    <div class="font-black text-[32px] mt-10 mb-2 text-brown flex items-center">
                        行事曆
                        <div class="bg-brown-100  text-[#f8f7f0] text-[14px] rounded-[20px] py-[10px] px-[24px] ml-3">
                            綁定Google日曆
                        </div>
                    </div>
                    <small class="text-[#8A8A8A]">
                    ...
                    <div class="flex items-center mt-3 justify-between">
                        <div
                            class="flex-1 text-center bg-brown-100  text-[#f8f7f0] text-[14px] rounded-[12px] py-[10px] px-[24px] ml-3">
                            諮商特約
                        </div>
                        <div
                            class="flex-1 text-center bg-brown-100  text-[#f8f7f0] text-[14px] rounded-[12px] py-[10px] px-[24px] ml-3">
